...
<head>
  ...
  <!-- Title -->
  <title><?php echo "$pagename"; ?> - Poly Bookstore</title>
  <!-- Favicon -->
  <!-- Core Stylesheet -->
...
<script>
 ...
 <script type="text/javascript">
  function pro(files,image,name,amount,id)
  {
    ...
    if (find !== null) {
      ...
      tableform = "<div class='row' id='row"+id+"'> <div class='col-3'><img src='"+image+"' width='50px'> </div> <div class='col-3'>"+name+"<input type='hidden' id='pname' value='"+name+"-"+id+"-"+numbers+"' name='names[]'></div> <div class='col-3'>"+amount+"</div> <div class='col-2'><temp href='"+files+"' dowmload>pay first</temp></div></div>";
          ...
          <div class="col-12">
            <div class="top-header-content d-flex align-items-center justify-content-between">
              ...
              <div class="top-header-meta">
                <p>Welcome to <span>Poly Bookstore</span>, we hope you will enjoy our products and have good experience</p>
              </div>
              <!-- Top Header Content -->
              <div class="top-header-meta text-right">
                <a href="#" data-toggle="tooltip" data-placement="bottom" title="PolyBookstore@gmail.com"><i class="fa fa-envelope-o" aria-hidden="true"></i> <span>Email: PolyBookstore@gmail.com</span></a>
      ...
      <div class="classy-nav-container breakpoint-off">
        <div class="container">
          ...
          <nav class="classy-navbar justify-content-between" id="famieNav">
            <!-- Nav Brand -->
            <a href="index.php" class="nav-brand">Poly Bookstore</a>
            <!-- Navbar Toggler -->
